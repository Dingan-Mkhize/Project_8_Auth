...
ActiveRecord::Schema[7.0].define(version: 2024_04_24_113059) do
  ...
  create_table "volunteerings", force: :cascade do |t|
    ...
    t.index ["user_id", "volunteereable_id", "volunteereable_type"], name: "index_volunteerings_on_user_and_volunteereable", unique: true
